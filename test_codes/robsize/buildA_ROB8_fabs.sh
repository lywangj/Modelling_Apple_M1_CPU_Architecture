...
DELAY=(800)
LOOP=(141)
myArray=(100 200 250 300 350 360 370 380 390 400 410 420 430 440 450 500 600 700 800 900 1000)
OPArray=("fabs_s_D_indep")
REPEAT=5
...
test_insn () {
  ...
  elif [ $1 == "fabs_s_D_indep" ]
  then
    echo "        fabs d2, d1" >> $DIR/$1_$2_d$3_L$4.s
  elif [ $1 == "add_fabs_mixed" ]
  then
    echo "        add x1, x2, #1" >> $DIR/$1_$2_d$3_L$4.s
    echo "        fabs d2, d1" >> $DIR/$1_$2_d$3_L$4.s
  else
...
delay_sdiv () {
  echo "        sdiv x1, x1, x2" >> $DIR/$1_$2_d$3_L$4.s
}
