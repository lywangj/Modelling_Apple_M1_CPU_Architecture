...
myArray=(7)
OPArray=("and_imm_64" "and_reg_64" "and_reg_asr_64" "ands_reg_64" "ands_reg_ror_64" "cmp_uxtw_64" "cmp_imm_64" "cmp_reg_64" "cmp_reg_asr_64" "sdiv_fast_64" "mul_32" "mul_64" "umull")
REPEAT=30
...
test_insn () {
  if [ $1 == "and_imm_64" ]
  then
    echo "        and x1, x1, #3" >> $DIR/$1_$2.s
  elif [ $1 == "and_reg_64" ]
  then
    echo "        and x1, x1, x2" >> $DIR/$1_$2.s
  elif [ $1 == "and_reg_asr_64" ]
  then
    echo "        and x1, x1, x2, asr #17" >> $DIR/$1_$2.s
  elif [ $1 == "ands_reg_64" ]
  then
    echo "        ands x1, x1, x2" >> $DIR/$1_$2.s
  elif [ $1 == "ands_reg_ror_64" ]
  then
    echo "        ands x1, x1, x2, ror #17" >> $DIR/$1_$2.s
  elif [ $1 == "cmp_uxtw_64" ]
  then
    echo "        cmp x1, w1, uxtw" >> $DIR/$1_$2.s
  elif [ $1 == "cmp_imm_64" ]
  then
  ...
  then
    echo "        sdiv x1, x1, x2" >> $DIR/$1_$2.s
  elif [ $1 == "mul_32" ]
  then
    echo "        mul w1, w1, w2" >> $DIR/$1_$2.s
  elif [ $1 == "mul_64" ]
  then
    echo "        mul x1, x1, x2" >> $DIR/$1_$2.s
  elif [ $1 == "umull" ]
  then
    echo "        umull x1, w1, w2" >> $DIR/$1_$2.s
  else
    continue
  fi
}
