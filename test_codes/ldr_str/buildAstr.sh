...
myArray=(7)
OPArray=("str_32" "str_64" "str_unsigned_64" "str_reg_64")
REPEAT=30
...
test_insn () {
  if [ $1 == "str_32" ]
  then
    echo "        str w2, [x6]" >> $DIR/$1_$2.s
  elif [ $1 == "str_64" ]
  then
    echo "        str x2, [x6]" >> $DIR/$1_$2.s
  elif [ $1 == "str_unsigned_64" ]
  then
    echo "        str x2, [x6, #8]" >> $DIR/$1_$2.s
  elif [ $1 == "str_reg_64" ]
  then
    echo "        str x2, [x6, x7]" >> $DIR/$1_$2.s
  else
    continue
  fi
}
