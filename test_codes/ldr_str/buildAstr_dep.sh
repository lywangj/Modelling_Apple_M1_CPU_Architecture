...
test_insn () {
  ...
  then
    echo "        str x7, [x6]" >> $DIR/$1_$2.s
    echo "        ldr x5, [x6]" >> $DIR/$1_$2.s
  elif [ $1 == "str_64_dep" ]
  then
    echo "        str x7, [x6]" >> $DIR/$1_$2.s
    echo "        eor x8, x8, x7" >> $DIR/$1_$2.s
    echo "        eor x8, x8, x7" >> $DIR/$1_$2.s
    echo "        add x6, x6, x8" >> $DIR/$1_$2.s
  elif [ $1 == "str_64_dep2" ]
  then
    echo "        str x6, [x7]" >> $DIR/$1_$2.s
    echo "        eor x8, x8, x7" >> $DIR/$1_$2.s
    echo "        eor x8, x8, x7" >> $DIR/$1_$2.s
    echo "        add x6, x6, x8" >> $DIR/$1_$2.s
  elif [ $1 == "str_64_add" ]
  then
    echo "        str x7, [x6]" >> $DIR/$1_$2.s
    echo "        add x7, x7, #1" >> $DIR/$1_$2.s
  elif [ $1 == "str_64_print" ]
  then
    echo "        str x7, [x6]" >> $DIR/$1_$2.s
    echo "        ldr x5, [x6]" >> $DIR/$1_$2.s
    echo "        mov x0, #1" >> $DIR/$1_$2.s
    echo "        ldr x1, =_data" >> $DIR/$1_$2.s
